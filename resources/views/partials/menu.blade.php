<aside class="main-sidebar">
    <section class="sidebar" style="height: auto;">
        <ul class="sidebar-menu tree" data-widget="tree">
            ...
            @endcan
            @can('rendez_vou_access')
                <li class="treeview">
                    <a href="#">
                        <i class="fa-fw fas fa-book-open">

                        </i>
                        <span>{{ trans('cruds.rendezVou.title') }}</span>
                        <span class="pull-right-container"><i class="fa fa-fw fa-angle-left pull-right"></i></span>
                    </a>
                    <ul class="treeview-menu">
                        @can('test_covid_access')
                            <li class="{{ request()->is("admin/test-covids") || request()->is("admin/test-covids/*") ? "active" : "" }}">
                                <a href="{{ route("admin.test-covids.index") }}">
                                    <i class="fa-fw fas fa-vial">

                                    </i>
                                    <span>{{ trans('cruds.testCovid.title') }}</span>
