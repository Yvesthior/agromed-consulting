        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.edit') }} {{ trans('cruds.testCovid.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.test-covids.update", [$testCovid->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group {{ $errors->has('date_rendez_vous') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="date_rendez_vous" id="date_rendez_vous" value="{{ old('date_rendez_vous', $testCovid->date_rendez_vous) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('date_voyage') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="date_voyage" id="date_voyage" value="{{ old('date_voyage', $testCovid->date_voyage) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('nom') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="nom" id="nom" value="{{ old('nom', $testCovid->nom) }}" required>
                            @if($errors->has('nom'))
                        ...
                        <div class="form-group {{ $errors->has('prenoms') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="prenoms" id="prenoms" value="{{ old('prenoms', $testCovid->prenoms) }}">
                        ...
                        <div class="form-group {{ $errors->has('statut') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control" name="statut" id="statut" required>
                                ...
                                @foreach(App\Models\TestCovid::STATUT_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('statut', $testCovid->statut) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('telephone') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="telephone" id="telephone" value="{{ old('telephone', $testCovid->telephone) }}" step="1" required>
                        ...
                        <div class="form-group {{ $errors->has('sexe') ? 'has-error' : '' }}">
                            ...
                            @foreach(App\Models\TestCovid::SEXE_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="sexe_{{ $key }}" name="sexe" value="{{ $key }}" {{ old('sexe', $testCovid->sexe) === (string) $key ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('date_naissance') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="date_naissance" id="date_naissance" value="{{ old('date_naissance', $testCovid->date_naissance) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('email') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="email" name="email" id="email" value="{{ old('email', $testCovid->email) }}">
                            @if($errors->has('email'))
                        ...
                        <div class="form-group {{ $errors->has('adresse') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="adresse" id="adresse" value="{{ old('adresse', $testCovid->adresse) }}">
                        ...
                        <div class="form-group {{ $errors->has('heure_rendez_vous') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control timepicker" type="text" name="heure_rendez_vous" id="heure_rendez_vous" value="{{ old('heure_rendez_vous', $testCovid->heure_rendez_vous) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('destination') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="destination" id="destination" value="{{ old('destination', $testCovid->destination) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('heure_voyage') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control timepicker" type="text" name="heure_voyage" id="heure_voyage" value="{{ old('heure_voyage', $testCovid->heure_voyage) }}">
                        ...
                        <div class="form-group {{ $errors->has('message') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control" name="message" id="message">{{ old('message', $testCovid->message) }}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('nom_complet') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="nom_complet" id="nom_complet" value="{{ old('nom_complet', $testCovid->nom_complet) }}">
                        ...
                        <div class="form-group {{ $errors->has('resultat') ? 'has-error' : '' }}">
                            <label>{{ trans('cruds.testCovid.fields.resultat') }}</label>
                            <select class="form-control" name="resultat" id="resultat">
                                <option value disabled {{ old('resultat', null) === null ? 'selected' : '' }}>{{ trans('global.pleaseSelect') }}</option>
                                @foreach(App\Models\TestCovid::RESULTAT_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('resultat', $testCovid->resultat) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                            @if($errors->has('resultat'))
                                <span class="help-block" role="alert">{{ $errors->first('resultat') }}</span>
                            @endif
                            <span class="help-block">{{ trans('cruds.testCovid.fields.resultat_helper') }}</span>
                        </div>
