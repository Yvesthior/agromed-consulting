...
<html style="font-size: 16px;" lang="fr-SN">
  <head>
    ...
    <meta charset="utf-8">
    <meta name="keywords" content="test covid senegal
        test covid senegal
        test covid
        pcr
        dakar
    ...
    <link rel="stylesheet" href="{{ asset('css/success.css') }}" media="screen">
  ...
  <body class="u-body"><header class="u-clearfix u-gradient u-header u-sticky u-sticky-1e50 u-header" id="sec-df5d"><a href="/" class="u-image u-logo u-image-1" data-image-width="413" data-image-height="92">
        <img src="{{ asset('images/logo2-removebg-preview.png') }}" class="u-logo-image u-logo-image-1">
    ...
    <section class="u-clearfix u-section-1" id="carousel_1513">
      <div class="u-clearfix u-sheet u-sheet-1">
        <div class="u-container-style u-group u-opacity u-opacity-70 u-radius-30 u-shape-round u-white u-group-1" data-animation-name="fadeIn" data-animation-duration="1000" data-animation-delay="0">
          <div class="u-container-layout u-container-layout-1">
            <img class="u-expanded-width-md u-expanded-width-sm u-expanded-width-xs u-image u-image-contain u-image-default u-image-1" src="{{ asset('images/imgsuccess.png') }}" alt="" data-image-width="571" data-image-height="488" data-animation-name="fadeIn" data-animation-duration="2000" data-animation-delay="0" data-animation-direction="Down">
            <div class="u-container-style u-expanded-width-md u-expanded-width-sm u-expanded-width-xs u-group u-group-2">
              <div class="u-container-layout u-valign-middle-md u-valign-middle-sm u-valign-middle-xs">
                <h2 class="u-text u-text-custom-color-2 u-text-default-lg u-text-default-xl u-text-1" data-animation-name="slideIn" data-animation-duration="1000" data-animation-delay="0" data-animation-direction="Right">Votre Rendez-Vous a été enregistré avec Succès.</h2>
                <p class="u-text u-text-custom-color-2 u-text-2" data-animation-name="slideIn" data-animation-duration="2000" data-animation-delay="1000" data-animation-direction="Up">Vous serez contacté par une de nos équipe pour éffectuer le Prélèvement.</p>
              </div>
            </div>
          </div>
        </div>
